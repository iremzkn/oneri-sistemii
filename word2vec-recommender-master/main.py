...
#Açıklamayı kelimelere bölerek liste oluşturma
corpus = []
...
def recommendations(movie):
    ...
    # Başlık ve Film Görüntüsü Bağlantısını Alma ve 'movies' adı verilen yeni veri çerçevesinde saklama
...
# Kullanıcıdan film adı alma ve tavsiyeleri gösterme
while True:
